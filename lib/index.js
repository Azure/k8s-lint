...
var require_webidl = __commonJS({
  "node_modules/undici/lib/web/fetch/webidl.js"(exports, module) {
    ...
    webidl.util.Stringify = function(V) {
      const type3 = webidl.util.Type(V);
      switch (type3) {
        case "Symbol":
...
var require_client_h1 = __commonJS({
  "node_modules/undici/lib/dispatcher/client-h1.js"(exports, module) {
    ...
    var Parser = class {
      ...
      setTimeout(delay, type3) {
        if (delay !== this.timeoutValue || type3 & USE_FAST_TIMER ^ this.timeoutType & USE_FAST_TIMER) {
          if (this.timeout) {
...
var require_client_h2 = __commonJS({
  "node_modules/undici/lib/dispatcher/client-h2.js"(exports, module) {
    ...
    function writeH2(client, request) {
      ...
      stream2.once("frameError", (type3, code) => {
...
var require_readable = __commonJS({
  "node_modules/undici/lib/api/readable.js"(exports, module) {
    ...
    async function consume(stream2, type3) {
    ...
    function consumeEnd(consume2) {
      const { type: type3, body, resolve: resolve2, stream: stream2, length } = consume2;
      try {
        if (type3 === "text") {
  ...
  "node_modules/undici/lib/web/websocket/events.js"(exports, module) {
    ...
    var MessageEvent = class _MessageEvent extends Event {
      ...
      constructor(type3, eventInitDict = {}) {
        ...
        webidl.argumentLengthCheck(arguments, 1, prefix);
        type3 = webidl.converters.DOMString(type3, prefix, "type");
...
var require_util7 = __commonJS({
  "node_modules/undici/lib/web/websocket/util.js"(exports, module) {
    ...
    function failWebsocketConnection(ws, reason) {
      ...
      if (reason) {
        fireEvent("error", ws, (type3, init) => new ErrorEvent(type3, init), {
...
var require_connection = __commonJS({
  "node_modules/undici/lib/web/websocket/connection.js"(exports, module) {
    ...
    function onSocketClose() {
      ...
      fireEvent("close", ws, (type3, init) => new CloseEvent(type3, init), {
        wasClean,
        code,
        reason
      });
...
// src/kubeconform/kubeconform.ts
...
// src/kubeconform/kubeconform.ts
var TOOL_NAME = "kubeconform";
function getKubeconformArch() {
...
async function kubeconformLint(manifests, kubeconformOptions) {
  const toolPath = await which(TOOL_NAME, false) || await downloadKubeconform();
  for (const manifest of manifests) {
    const code = await exec(toolPath, [
      kubeconformOptions,
      manifest
    ]);
    if (code != 0) {
...
async function downloadKubeconform() {
  ...
  switch (os7.type()) {
    case "Linux":
    case "Darwin":
      const newPath = path6.join(path6.dirname(downloadPath), "tool.tar.gz");
  ...
  const kubeconformPath = path6.join(
    extractedPath,
    TOOL_NAME + getExecutableExtension()
  );
  fs4.chmodSync(kubeconformPath, "755");
  addPath(extractedPath);
  return kubeconformPath;
}
function getKubeconformDownloadUrl(arch3) {
  switch (os7.type()) {
    case "Linux":
      return `https://github.com/yannh/kubeconform/releases/latest/download/kubeconform-linux-${arch3}.tar.gz`;
    case "Darwin":
      return `https://github.com/yannh/kubeconform/releases/latest/download/kubeconform-darwin-${arch3}.tar.gz`;
    case "Windows_NT":
    default:
      return `https://github.com/yannh/kubeconform/releases/latest/download/kubeconform-windows-${arch3}.zip`;
  }
}

// src/kubectl/kubectl.ts
var TOOL_NAME2 = "kubectl";
async function kubectlLint(manifests, namespace) {
  if (!process.env["KUBECONFIG"])
    throw Error("KUBECONFIG env is not explicitly set.");
  const kubectlPath = await which(TOOL_NAME2, false);
  if (!kubectlPath)
    throw Error(
      "Kubectl not found. You must install it before running this action."
    );
  for (const manifest of manifests) {
    await exec(kubectlPath, [
      "apply",
      "-f",
      manifest,
      "--dry-run=server",
